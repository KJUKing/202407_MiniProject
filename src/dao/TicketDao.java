...
public class TicketDao {
	...
	public List<MemberVo> ticketCheckList(List<Object> param) {
		...
		String sql = "SELECT J.HFDNIC AS MEM_NICK, I.MN AS MOVIE_NAME, I.EGN AS GENRE, I.KPT AS PART_TYPE, I.RUNNING_TIME AS RUNNING_TIME, J.HRN AS ROW_NUM, J.HSN AS SEAT_NUM, J.HFTP AS PRICE, I.FDTN AS THE_NAME, HFDTI AS TICKET\r\n" +
	...
	public TicketVo ticketDelBeforeSel(List<Object> param) {
		String sql = "SELECT FK_BK_CODE\r\n" +
				"FROM TICKET\n" +
				"WHERE TICKET = ?";
		return jdbc.selectOne(sql, param, TicketVo.class);
	}
}
