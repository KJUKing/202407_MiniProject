...
//		var1();
	...
	public void ticketDetail(String movieName, String runningTime, String rowNum, int seatNum, String theName, String partType, int ticket) {
		printLn(1);
		spacePrint1();
		System.out.println("╭─────────────────────╮");
		spacePrint1();
	...
	public void ticketCancelPrint() {
		printLn(3);
		spacePrint2();
		System.out.println("    [  선택하신 티켓 예매를 취소하였습니다  ]");
		printLn(3);
		DelayUtil.delay(2000);
	}
